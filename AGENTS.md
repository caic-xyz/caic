...
use `make screenshots-update` to accept intentional visual changes. Do not use bare
`pnpm playwright test`: it bypasses `e2e/playwright.config.ts`. For a
...
- `scripts/test_visual_screenshots.py`: Unit tests for deterministic screenshot luminance comparison.
...
- `scripts/visual_screenshots.py`: Check or update deterministic frontend and Android documentation screenshots.
- `sdk/AGENTS.md`: SDKs
