...
- `sdk/halo-ble/src/main/kotlin/com/caic/halo/ble/HaloConnection.kt`: HaloConnection manages BLE scanning, connection, bonding, MTU negotiation, service discovery, and GATT writes for Halo/Frame devices.
