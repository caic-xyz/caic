...
- `docs/PLAN_HARNESS_HANDOFF.md`: Goal
...
- `scripts/android_start_emulator.py`: Start or reuse the caic_test Android emulator and wait until it has booted.
...
- `scripts/test_android_e2e.py`: Unit tests for the Android end-to-end launcher.
