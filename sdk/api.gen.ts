...
import type { ClaudeEventMessage, ConfigJSON, CreateTaskReq, CreateTaskResp, ErrorResponse, EventMessage, HarnessJSON, InputReq, RepoJSON, RestartReq, StatusResp, SyncReq, SyncResp, TaskJSON, UsageResp, VoiceTokenResp } from "./types.gen";
...
export function getConfig(): Promise<ConfigJSON> {
  return request<ConfigJSON>("GET", "/api/v1/config");
}
