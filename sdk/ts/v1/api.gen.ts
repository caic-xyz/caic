...
import type { BotFixCIReq, BotFixPRReq, CILogResp, CloneRepoReq, CompactReq, Config, CreateTaskReq, CreateTaskResp, DiffResp, ErrorResponse, EventMessage, ForkTaskReq, HarnessInfo, InputReq, PreferencesResp, ProcessListResp, Repo, RepoBranchesResp, RestartReq, SignalProcessReq, StatusResp, SyncReq, SyncResp, Task, TaskListEvent, TaskToolInputResp, UpdatePreferencesReq, UsageResp, UserResp, VoiceRTCAnswerResp, VoiceRTCOfferReq, VoiceTokenResp, WebFetchReq, WebFetchResp, WellKnownCachesResp } from "./types.gen";
