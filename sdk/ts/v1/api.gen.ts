...
import type { BotFixCIReq, BotFixPRReq, CILogResp, CloneRepoReq, CompactReq, Config, CreateTaskReq, CreateTaskResp, DiffResp, ErrorResponse, EventMessage, ForkTaskReq, HarnessInfo, InputReq, PreferencesResp, ProcessListResp, Repo, RepoBranchesResp, RestartReq, SignalProcessReq, StatusResp, SyncReq, SyncResp, Task, TaskListEvent, TaskToolInputResp, UpdatePreferencesReq, UpdateResp, UsageResp, UserResp, VersionResp, VoiceRTCAnswerResp, VoiceRTCOfferReq, VoiceTokenResp, WebFetchReq, WebFetchResp, WellKnownCachesResp } from "./types.gen";
...
export function createApiClient(fetchFn: FetchFn = (globalThis as any).fetch.bind(globalThis)) {
  ...
  return {
    ...
    getVersion: (): Promise<VersionResp> => request<VersionResp>("GET", "/api/v1/server/version"),
    /** Triggers a background server auto-update to the latest release. */
    triggerUpdate: (): Promise<UpdateResp> => request<UpdateResp>("POST", "/api/v1/server/update"),
