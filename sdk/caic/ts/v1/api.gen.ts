...
import type { BotFixCIReq, BotFixPRReq, CILogResp, CacheSizesResp, CloneRepoReq, CompactReq, Config, CreateTaskReq, DiffResp, ErrorResponse, EventMessage, ForkTaskReq, HarnessInfo, InputReq, OAuthGrantsResp, PreferencesResp, ProcessListResp, Repo, RepoBranchesResp, RestartReq, RevokeOAuthGrantReq, SignalProcessReq, StatusResp, SyncReq, SyncResp, Task, TaskHandoffResp, TaskHistoryStreamError, TaskInfo, TaskListEvent, TaskToolInputResp, UpdatePreferencesReq, UpdateResp, UsageResp, UserResp, VersionResp, WebFetchReq, WebFetchResp, WellKnownCachesResp } from "./types.gen";
