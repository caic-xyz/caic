...
import type { BotFixCIReq, BotFixPRReq, CILogResp, CacheSizesResp, CloneRepoReq, CompactReq, Config, CreateTaskReq, DiffResp, ErrorCode, ErrorResponse, EventMessage, FileDiffResp, ForkTaskReq, HarnessInfo, InputReq, OAuthGrantsResp, PreferencesResp, ProcessListResp, Repo, RepoBranchesResp, RestartReq, RevokeOAuthGrantReq, SignalProcessReq, StatusResp, SyncReq, SyncResp, Task, TaskDiffIndexResp, TaskHandoffResp, TaskHistoryStreamError, TaskInfo, TaskListEvent, TaskRepoStatusResp, TaskToolInputResp, UpdatePreferencesReq, UpdateResp, UsageResp, UserResp, VersionResp, WebFetchReq, WebFetchResp, WellKnownCachesResp } from "./types.gen";
