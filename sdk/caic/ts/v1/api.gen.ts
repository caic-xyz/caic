...
import type { BotFixCIReq, BotFixPRReq, CILogResp, CacheSizesResp, CloneRepoReq, CompactReq, Config, CreateTaskReq, CreateTaskResp, DiffResp, ErrorResponse, EventMessage, ForkTaskReq, HarnessInfo, InputReq, PreferencesResp, ProcessListResp, Repo, RepoBranchesResp, RestartReq, SignalProcessReq, StatusResp, SyncReq, SyncResp, Task, TaskListEvent, TaskToolInputResp, UpdatePreferencesReq, UpdateResp, UsageResp, UserResp, VersionResp, WebFetchReq, WebFetchResp, WellKnownCachesResp } from "./types.gen";
