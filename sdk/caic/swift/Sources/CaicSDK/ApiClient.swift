...
public final class ApiClient {
    ...
    public func listOAuthGrants() async throws -> OAuthGrantsResp {
        try await request("GET", path: "/api/caic/v1/oauth/grants")
    }
    /// Revokes one connected OAuth client grant for the authenticated user.
    public func revokeOAuthGrant(grantID: String, req: RevokeOAuthGrantReq) async throws -> StatusResp {
        try await request("POST", path: "/api/caic/v1/oauth/grants/\(grantID)/revoke", body: try encoder.encode(req))
    }
