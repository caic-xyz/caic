...
public struct QuotaProvider: Codable, Equatable, Hashable {
    ...
    public static let Gemini = QuotaProvider("gemini")
    public static let Grok = QuotaProvider("grok")
    public static let Groq = QuotaProvider("groq")
...
public struct MetricResource: Codable {
