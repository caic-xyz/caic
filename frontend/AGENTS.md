...
- `src/DiffView.tsx`: Full-page diff viewer for a task's file changes.
...
- `src/TaskView.test.tsx`: Tests for the TaskView diff link navigation.
...
- `src/VoiceFunctions.ts`: Gemini function declarations and dispatch for voice mode.
- `src/VoiceOverlay.tsx`: Voice overlay component: persistent bottom panel with mic button and voice controls.
- `src/VoiceSession.ts`: Core Gemini Live voice session manager for the web frontend.
