...
var Routes = []Route{
	...
	},
	{
		...
		Method:      "GET",
		Path:        "/api/caic/v1/tasks/{id}/ci-log",
	...
	},
	{
		...
		Method: "GET",
		Path:   "/api/caic/v1/tasks/{id}/processes",
	...
	},
	{
		...
		Method: "POST",
		Path:   "/api/caic/v1/tasks/{id}/processes/{pid}/signal",
	...
	},
	{
		...
		Method: "GET",
		Path:   "/api/caic/v1/server/tasks/events",
	...
	},
	{
		...
		Method: "GET",
		Path:   "/api/caic/v1/server/usage/events",
