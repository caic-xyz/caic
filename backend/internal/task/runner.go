...
func (r *Runner) ForkTask(ctx context.Context, source, fork *Task, forkOpts *ForkOptions) (*SessionHandle, error) {
	...
	tlog.Debug("runner", "msg", "calling container.Fork", "source", source.Container, "harness", forkOpts.Harness, "tailscale", forkOpts.Tailscale, "usb", forkOpts.USB, "display", forkOpts.Display, "sudo", forkOpts.Sudo)
...
func (r *Runner) setup(ctx context.Context, t *Task, labels []string) (setupResult, error) {
	...
	r.log.Info("starting container", "br", primaryBranch, "img", t.DockerImage, "hns", t.Harness, "ts", t.Tailscale, "usb", t.USB, "dpy", t.Display, "sudo", t.Sudo)
	tContainer := time.Now()
