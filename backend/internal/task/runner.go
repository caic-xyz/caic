...
type ContainerBackend interface {
	...
	Diff(ctx context.Context, id runtime.InstanceID, repoIdx int, args ...string) (string, error)
	Fetch(ctx context.Context, id runtime.InstanceID) error
	...
	Purge(ctx context.Context, id runtime.InstanceID) error
	...
	Revive(ctx context.Context, id runtime.InstanceID) error
