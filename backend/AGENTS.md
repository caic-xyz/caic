...
- `internal/agent/claude/wire.go`: Record probe type used by Record.UnmarshalJSON.
...
- `internal/agent/codex/wire.go`: JSON-RPC probe types used by ParseMessage and handshake.
