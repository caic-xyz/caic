...
- `app/src/main/java/com/fghbuild/caic/voice/VoiceSession.kt`: Manages Gemini Live WebSocket session, audio I/O, and function call dispatch. Keep in sync with frontend/src/VoiceSession.ts
