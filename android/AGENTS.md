...
- `app/src/main/java/com/fghbuild/caic/ui/tasklist/UsageBadges.kt`: Usage badges showing rolling window cost derived from container output.
...
- `app/src/main/java/com/fghbuild/caic/voice/VoiceSession.kt`: Manages Gemini Live WebSocket session, audio I/O, and function call dispatch.
