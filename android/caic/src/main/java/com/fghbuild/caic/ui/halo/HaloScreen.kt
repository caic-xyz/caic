// Compose Halo screen for scanning, connecting, and managing Halo device preferences.
package com.fghbuild.caic.ui.halo
...
import com.fghbuild.caic.halo.HaloConnectionState
import com.fghbuild.caic.halo.HaloDeviceItem
import com.fghbuild.caic.halo.HaloViewModel
...
@Composable
fun HaloScreen(
    viewModel: HaloViewModel = hiltViewModel(),
    onNavigateBack: () -> Unit,
) {
    ...
    Scaffold(
        ...
        Column(
            ...
            val bondedAddress = state.haloAddress
            if (bondedAddress != null) {
                ListItem(
                    headlineContent = { Text("Selected device") },
                    supportingContent = { Text(bondedAddress) },
                    trailingContent = {
            ...
            Row(
                ...
                if (state.connectionState == HaloConnectionState.Scanning) {
